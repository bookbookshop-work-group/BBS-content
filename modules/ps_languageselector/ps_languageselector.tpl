<div id="_desktop_language_selector">
  <div class="language-selector-wrapper">
    ...
    <div class="language-selector dropdown js-dropdown">
      <button data-toggle="dropdown" style="background-color:inherit; border: 0px" class="hidden-sm-down btn-unstyle" aria-haspopup="true" aria-expanded="false" aria-label="{l s='Language dropdown' d='Shop.Theme.Global'}">
        <img src="{$urls.img_url}/flags/{$current_language.iso_code}.png" alt="{$current_language.name_simple}" />
        ...
        {foreach from=$languages item=language}
          <li {if $language.id_lang == $current_language.id_lang} class="current" {/if}>
            <a href="{url entity='language' id=$language.id_lang}" class="dropdown-item" data-iso-code="{$language.iso_code}">
              <img src="{$urls.img_url}/flags/{$language.iso_code}.png" alt="{$language.name_simple}" />
            </a>
          </li>
        {/foreach}
      </ul>
