...
{else}
  ...
  <div style="margin-bottom:10px!"  class="form-group row {if !empty($field.errors)}has-error{/if}">
    <label style=" fantasy; font-size: 20px;"  class="col-md-3 form-control-label{if $field.required} required{/if}" for="field-{$field.name}">
